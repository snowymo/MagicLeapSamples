...
namespace prefabs {
  ...
  class LoadingSpinnersBase : public PrefabBase {
  public:
  ...
  private:
    ...
    LoadingSpinnersBase(ExtendedPrefabManager* extendedPrefabManager, lumin::Node* root);
    ~LoadingSpinnersBase() override;
  };
}
