...
namespace prefabs {
  ...
  class EclipseLabelsPrefab;

  class EclipseLabelsPrefabBase : public PrefabBase {
  public:
  ...
  private:
    ...
    friend class EclipseLabelsPrefab;
    ...
    EclipseLabelsPrefabBase(ExtendedPrefabManager* extendedPrefabManager, lumin::Node* root);
    ~EclipseLabelsPrefabBase() override;
  };
}
